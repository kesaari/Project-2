...
describe("promiseRace", () => {
  it("Должна возвращать результат первого выполнившегося промиса", async () => {
  ...
  it("Должна прокидывать ошибку", async () => {
  ...
  it("не должна вызывать Promise.race стандартной библиотеки", () => {
